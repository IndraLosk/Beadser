...
public class Cherry extends AppCompatActivity {
    ...
    public void check(){
        if (countImg == 2) {
            ...
            img.setImageResource(R.drawable.cherryring02);
            toLeft.setImageResource(R.drawable.toleftpassiv);
        }
        else if (countImg == 3)
        {
            label.setText("\t\t\t2 из 6");
            img.setImageResource(R.drawable.cherryring03);
            toLeft.setImageResource(R.drawable.toleftactive);
        }
        else if (countImg == 4) {
            label.setText("\t\t\t3 из 6");
            img.setImageResource(R.drawable.cherryring04);
        }
        else if (countImg == 5) {
            label.setText("\t\t\t4 из 6");
            img.setImageResource(R.drawable.cherryring05);
        }
        else if (countImg == 6) {
            label.setText("\t\t\t5 из 6");
            img.setImageResource(R.drawable.cherryring06);
            toRight.setImageResource(R.drawable.torightactive);
        }
        else if (countImg == 7) {
            label.setText("\t\t\t6 из 6");
            img.setImageResource(R.drawable.cherryring07);
